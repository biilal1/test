...
Zel_Uid = zedub.uid
zed_dev = (1895219306, 925972505, 5176749470, 2095357462, 5746412340, 232499688, 1985225531, 5176749470, 6470835326, 1719023510, 6963296170, 6146997910)
...
ZelzalViip_Orders = (
"[ᯓ 𝗭𝗧𝗵𝗼𝗻 𝗩𝗶𝗽 🌟 الاوامــر المميـزة](t.me/ZThon) .\n"
"⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆\n"
"**✾╎قـائمـة اثنين من الاوامـر المميـزة الخاصـة بسـورس زدثـــون :** \n\n"
"`.تفعيل الكاشف الذكي`\n"
"**⪼ بالـرد ع الشخـص او بإضافة ايـدي او يـوزر الشخـص للامـر**\n"
"**⪼ لـ تفعيـل إشعـارات كشـف ومراقبـة حسـاب شخـص متصـل 🛜**\n\n\n"
"`.تعطيل الكاشف الذكي`\n"
