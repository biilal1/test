...
ZelzalSuper_cmd = (
    "[ᯓ 𝗦𝗼𝘂𝗿𝗰𝗲 𝗭𝗧𝗵𝗼𝗻 🎡 النشـࢪ التڪࢪاࢪي العـام](t.me/ZThon) .\n"
    "**⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆**\n"
    ...
    if event.reply_to_msg_id:
        ...
        if BOTLOG:
            await event.client.send_message(
                BOTLOG_CHATID,
                "ᯓ 𝗦𝗼𝘂𝗿𝗰𝗲 𝗭𝗧𝗵𝗼𝗻 🎡 **النشــࢪ التڪـࢪاࢪي العـام**\n**⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆**\n"
...
async def gcast(event):
    ...
    if BOTLOG:
        rss = "ᯓ 𝗦𝗼𝘂𝗿𝗰𝗲 𝗭𝗧𝗵𝗼𝗻 🎡 <b>النشــࢪ التڪـࢪاࢪي العـام</b>\n<b>⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆</b>"
...
async def add_blacklist_chat(event):
    ...
    output = ""
    if result != "":
        output += f"ᯓ 𝗦𝗼𝘂𝗿𝗰𝗲 𝗭𝗧𝗵𝗼𝗻 🎡 **ڪـࢪوبـات السوبـࢪ**\n**⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆**\n{result}\n"
    if errors != "":
        output += f"**• الاخطـاء :**\n{errors}\n"
    if result != "":
        output += "**• يتـم الان اعـادة تشغيـل بـوت زدثــون**\n"
...
async def add_blacklist_chat(event):
    ...
    result = "ᯓ 𝗦𝗼𝘂𝗿𝗰𝗲 𝗭𝗧𝗵𝗼𝗻 🎡 **ڪـࢪوبـات السوبـࢪ**\n**⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆**\n"
